  ...
  return (
    <div className={cn('rounded-2xl border border-[#e8eaee] bg-white p-3.5 shadow-[0_4px_24px_rgba(31,31,31,0.06)]', className)}>
      ...
      <div className="space-y-4">
        <div>
          <p className="mb-2 text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#8b94a4]">Nurse type</p>
        ...
        <div>
          <p className="mb-2 text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#8b94a4]">Care type</p>
        ...
        <div>
          <p className="mb-2 text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#8b94a4]">Care mode</p>
          <div className="flex flex-wrap gap-2">
            {nurseCareModes.map((m) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'rounded-full border px-3 py-1.5 text-[0.72rem] font-semibold transition-colors [touch-action:manipulation]',
                    active
                      ? 'border-[#e91e8c] bg-[#fdeef6] text-[#9d1b6a]'
                      : 'border-[#e8eaee] bg-white text-[#5e616e] hover:border-[#cfd6e4]',
                  )}
        ...
        <div>
          <p className="mb-2 text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#8b94a4]">Visit fee</p>
