import { consultLabHeroCopy } from '../data/labsData'
...
export function LabHero({ frameSrc, characterSrc, onBookNow }: LabHeroProps) {
  return (
    <div className="relative mt-0 w-full overflow-hidden rounded-[18px]">
      {/* Container with strict aspect ratio and isolation */}
      <div className="relative aspect-[1200/397] w-full min-h-[200px] max-h-[34vh] overflow-hidden bg-[#FFF8EB]">
        {/* Layer 1: Background Layer */}
        <div className="absolute inset-0 z-0 bg-[#FFF8EB]">
          <img
            src={frameSrc}
            alt=""
            width={1200}
